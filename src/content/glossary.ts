export const TERM_DEFINITIONS: Record<string, string> = {
  "Trip-edge": "Only the cutting edge trips over obstacles to keep the snow load.",
  "Full-trip": "The entire moldboard trips to absorb impact, gentler on truck.",
  "Moldboard": "Curved plow surface that rolls and casts snow away from the lane.",
  "Cutting Edge": "Replaceable blade segment that performs the scraping on pavement.",
  "Underbody Scraper": "Down-pressure blade mounted mid‑chassis for hard pack removal.",
  "Wing Plow": "Side-mounted blade to widen cleared width in a single pass.",
  "Pre-wet": "Liquids added to salt to reduce bounce/scatter and speed activation.",
  "Anti-ice": "Liquid treatment applied before storms to prevent ice bond formation.",
  "Brine": "Salt-in-water solution used for anti‑icing and pre‑wetting strategies.",
